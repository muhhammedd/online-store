					...
					<div class="row">
						<div class="col-md-12 d-flex ftco-animate">
							<div class="blog-entry align-self-stretch d-md-flex">
								<a href="{{ route('blog.show', '8-tips-for-shopping') }}" class="block-20"
								...
								<div class="text d-block pl-md-4">
									...
									<p><a href="{{ route('blog.show', '8-tips-for-shopping') }}" class="btn btn-primary py-2 px-3">Read more</a></p>
								</div>
							</div>
						</div>
						<div class="col-md-12 d-flex ftco-animate">
